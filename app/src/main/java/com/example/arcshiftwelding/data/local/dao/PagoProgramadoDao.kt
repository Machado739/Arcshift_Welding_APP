...
interface PagoProgramadoDao {
    ...
    """)
    fun obtenerPagosPorProyecto(proyectoId: Int): Flow<List<PagoProgramadoEntity>>
    ...
    @Query("""
        ...
        ORDER BY fechaProgramada ASC
    """)
    fun obtenerPagosPorCliente(clienteId: Int): Flow<List<PagoProgramadoEntity>>
    ...
    @Query("""
        ...
        WHERE id = :pagoProgramadoId
    """)
    suspend fun desactivarPagoProgramado(pagoProgramadoId: Int)
}